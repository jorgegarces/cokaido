...
public class AboutCasting {
    ...
    class Child extends Parent {
        ...
        public String cry() {
            return "Buu hu hu uuu!";
        }

    }

    class Pepito extends Grandparent{
        public String complain() {
            return "Grillo";
        }
    }
    ...
    public void downcastWithInheritance() {
        Grandparent child = new Child(); // Grandparent.class
    ...
    public void downcastAndPolymorphism() {
        ...
        System.out.println("Child: " + child.propina());
        assertEquals(parent.complain(), parent.complain());
    }
